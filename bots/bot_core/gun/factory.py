...
from bot_core.gun.guns.linear.gun import LINEAR_ACCEL_DAMPED_MODE, LINEAR_MODE, LINEAR_WALL_AWARE_MODE, LinearGun
    ...
    *,
    ...
    def component_factory(history: TargetHistoryStore):
        return [
            ...
            LinearGun(min_switch_visits=min_visits, min_switch_score=min_switch_score, mode=LINEAR_ACCEL_DAMPED_MODE),
