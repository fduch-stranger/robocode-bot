...
CIRCLE_SELECTABLE_GUN_MODES = DEFAULT_LIVE_GUN_MODES
CIRCLE_FORCE_GUN_MODES = STANDARD_FORCE_GUN_MODES
CIRCLE_DYNAMIC_CLUSTER_POLICY = DynamicClusterPolicy.from_env("ROBOCODE_CIRCLE")


def _selectable_gun_modes() -> frozenset[str]:
    return gun_modes_from_env("ROBOCODE_CIRCLE", CIRCLE_SELECTABLE_GUN_MODES, CIRCLE_FORCE_GUN_MODES)
