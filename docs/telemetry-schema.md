...
| `gun.low_energy_endgame` | `target`, `stage`, `decision`, `reason` | `energy`, `target_energy`, `distance`, `firepower`, `proposed_firepower`, `aim_mode`, `gun_bearing`, `alignment_limit`, `shot_quality` | - |
...
| `gun.traditional_gf_profile` | `target` | `aim_mode`, `global_guess_factor`, `global_weight`, `segment_guess_factor`, `segment_weight`, `blend`, `raw_guess_factor`, `selected_guess_factor`, `source` | - |
